            ...
            <ion-card>
                ...
                <ion-card-content>
                    ...
                    <ion-list>
                        ...
                        <ion-input v-model="name" label="Nama" label-placement="floating" fill="solid" placeholder="Masukan Nama"></ion-input>

                        <ion-input v-model="email" label="Email" label-placement="floating" fill="solid" placeholder="Masukan Email"></ion-input>
                        
                        <ion-input v-model="Telephone" label="Telp" label-placement="floating" fill="solid" placeholder="Masukan Telephone"></ion-input>
                        ...
                        <ion-textarea label="Alamat" v-model="address" label-placement="floating" fill="solid" placeholder="Masukan Alamat"></ion-textarea>
                    </ion-list>
